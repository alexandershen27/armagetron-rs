...
impl Line {
    ...
    pub fn hit(&self, other: Line) -> bool {
        if self.is_horizontal() && other.is_vertical() {
            ...
            return other.pos1.x >= self_min_x && other.pos1.x <= self_max_x 
                && self.pos1.y >= other_min_y && self.pos1.y <= other_max_y;
        } 
        ...
        if self.is_vertical() && other.is_horizontal() {
            ...
            return self.pos1.x >= other_min_x && self.pos1.x <= other_max_x 
                && other.pos1.y >= self_min_y && other.pos1.y <= self_max_y;
        }
...
impl Line {
    fn is_horizontal(&self) -> bool {
        return self.pos1.y == self.pos2.y;
    }
